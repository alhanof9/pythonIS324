...
class admin:
    def __init__(self):
        ...
        self.workshopnameLabel = tkinter.Label(self.workshopnameFrame, text="Workshop Name", font=('Arial', 10),
                                               width=15)
        ...
        # Buttons
        self.CreateButton = tkinter.Button(self.bottomFrame, bg="light blue", height=1, width=25, text='Create',
                                           font=('Times New Roman', 12), command=self.Create)

        self.BackupButton = tkinter.Button(self.bottomFrame, bg="light blue", height=1, width=25, text='Backup',
                                           font=('Times New Roman', 12), command=self.Backup)

        self.LogoutButton = tkinter.Button(self.bottomFrame, bg="light blue", height=1, width=25, text='Logout',
                                           font=('Times New Roman', 12), command=self.logout)
    ...
    def Create(self):
        ...
        try:
            ...
            cursor.execute(
                "INSERT INTO workshop(ID, Name,Location,Date,Time,Capacity,numberOfBook) VALUES(?,?,?,?,?,?,?)",
                (ID, Name, Location, Date, Time, Capacity, 0))
            conn.commit()
    ...
    def Backup(self):
        ...
        fileCSV = open('backup.csv', 'w', newline='\n')
        ...
        user_infoRows = conn.execute("SELECT * FROM user_info")
